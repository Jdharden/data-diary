...
Issues and pull requests welcome. If you're proposing a substantial feature, open an issue first so we can talk about whether it fits the "stay small, stay focused" goal.
